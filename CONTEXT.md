...
**Mehrfachbearbeitung**:
Gleichzeitiges Setzen ausgewählter Felder für mehrere Materialien oder Produkte, in der UI als **Aktionsblöcke** (Feld und zugehörige Controls gruppiert). Erlaubt ohne Extra-Warnung: Mindestbestand, Tags; bei Produkten und Materialien **Ist-Vorlage**; bei Produkten zusätzlich Produktfamilie; bei Materialien zusätzlich Materialfamilie. Mit **warnender Nachfrage** vor dem Speichern außerdem: **Bestand** (gleicher Absolutwert an einem gewählten Standort), **Stückliste** (eine Zeile hinzufügen oder ändern; übrige Zeilen bleiben) und **Löschen** der gesamten Auswahl. Löschmodus deaktiviert die übrigen Blöcke; nicht löschbare Einträge (z. B. Material in Produkt-Stückliste) werden übersprungen und gemeldet. Nicht per Mehrfach: Name, Farbe. Auswahl: Checkboxen in der Tabelle und/oder „ganze Produkt-/Materialfamilie“.
_Avoid_: Massen-Umbenennung; Massen-Farbänderung; Bestand/Stückliste/Löschen ohne Warn-Dialog; Mehrfach-Bestand als Delta; Mehrfach-Stückliste als komplettes Ersetzen aller Zeilen; Bearbeiten und Löschen in einem Speichern-Schritt mischen
